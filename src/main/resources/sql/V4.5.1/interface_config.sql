...
Interface_name	Varchar(16) COMMENT	'第三方接口名(唯一索引)',
...
is_deleted	Varchar(4) COMMENT	'是否删除(yes,no)',
created_at	timestamp  COMMENT	'创建时间' DEFAULT now(),
created_by	Varchar(32) COMMENT	'创建人',
laste_updated_at	timestamp  COMMENT	'最后更新时间' DEFAULT now(),
laste_updated_by	Varchar(32)	COMMENT '最后更新人',
PRIMARY KEY (`id`)
);