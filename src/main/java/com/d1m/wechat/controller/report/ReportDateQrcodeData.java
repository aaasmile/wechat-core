...
public class ReportDateQrcodeData extends AbstractExcelView{
	...
	protected void buildExcelDocument(Map<String, Object> model,
		...
		String[] keys = {"no", "date", "report.qrcode.title", "report.qrcode.category", "report.qrcode.total.scan", 
				"report.qrcode.total.scan.follower", "report.qrcode.new.scan.follower", "report.qrcode.scence"};
...
//				dataRow.createCell(4).setCellValue(dto.getQrCodeParentType());
				dataRow.createCell(4).setCellValue(dto.getScanNum());
				dataRow.createCell(5).setCellValue(dto.getUserByScan());
				dataRow.createCell(6).setCellValue(dto.getAttentionByScan());
				dataRow.createCell(7).setCellValue(dto.getScene());
				rowId++;
			}
		}
