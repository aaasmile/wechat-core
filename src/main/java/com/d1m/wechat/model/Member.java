...
public class Member {
     ...
     * 设置是否关注(1:关注,0:取消关注)
     *
     * @param isSubscribe 是否关注(1:关注,0:取消关注)
     */
     ...
     * 设置最后一次会话时间
     *
     * @param lastConversationAt 最后一次会话时间
     */
