...
public class EstoreProductSpecListResult {
	...
	public List<EstoreProductImage> getListProductSpecImage() {
		return listProductSpecImage;
	}

	public void setListProductSpecImage(List<EstoreProductImage> listProductSpecImage) {
		this.listProductSpecImage = listProductSpecImage;
	}
}