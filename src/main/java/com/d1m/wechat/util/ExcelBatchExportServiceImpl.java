...
/**
 * Created by jone.wang on 2018/12/7.
 * Description:
 */
@SuppressWarnings("WeakerAccess")
public class ExcelBatchExportServiceImpl extends ExcelExportService {

    private static ThreadLocal<ExcelBatchExportServiceImpl> THREAD_LOCAL = new ThreadLocal<>();
    ...
    public static ExcelBatchExportServiceImpl getExcelBatchExportService(ExportParams entity,
                                                                         Class<?> pojoClass) {
        if (THREAD_LOCAL.get() == null) {
            ExcelBatchExportServiceImpl batchServer = new ExcelBatchExportServiceImpl();
    ...
    public static ExcelBatchExportServiceImpl getCurrentExcelBatchExportService() {
        return THREAD_LOCAL.get();
    }
