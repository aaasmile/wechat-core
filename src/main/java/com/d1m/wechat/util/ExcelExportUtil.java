...
public class ExcelExportUtil {
    ...
    public static Workbook exportBigExcel(ExportParams entity, Class<?> pojoClass,
                                          Collection<?> dataSet) {
        ExcelBatchExportServiceImpl batchService = ExcelBatchExportServiceImpl
    ...
    public static void closeExportBigExcel() {
        ExcelBatchExportServiceImpl batchService = ExcelBatchExportServiceImpl.getCurrentExcelBatchExportService();
